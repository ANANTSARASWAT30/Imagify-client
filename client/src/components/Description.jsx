      ...
      items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI 
                image generator. Whether you need stunning visuals or unique imagery, our tool transform you text into eye-catching images with just a few clicks.
            ...
            <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge
                 producgt visuals to character designs and portraits,
                 even concepts that don't yet exist can be visualized effortlessly.
                  Powerd by advanced AI technology, the creative possibilities are limitless!
            </p>
